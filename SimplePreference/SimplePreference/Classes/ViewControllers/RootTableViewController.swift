...
let kContactPreferenceLKey = "contact_preference"
...
class RootTableViewController: UITableViewController {
    ...
    func getAppPreferencesFromStringBundle() {
        appPreferences = AppPreferences(ids: [kFirstNamePreferenceKey, kLastNameLPreferenceLKey, kContactPreferenceLKey])
